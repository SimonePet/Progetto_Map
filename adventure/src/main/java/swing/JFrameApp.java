...
public class JFrameApp extends javax.swing.JFrame {
    ...
    public JFrameApp(final String usernameCorr, final FrameStart frameCorr) {
        this.username = usernameCorr;
        this.frameStart = frameCorr;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lblStanzaCorrente.setFont(new java.awt.Font("Segoe UI", Font.BOLD, 18)); // NOI18N
    ...
    private void formWindowOpened() { //GEN-FIRST:event_formWindowOpened
        ...
        labelNumMosse.setText(String.valueOf(engine.getGame().getNumMosse()));
        GameDescription partita = engine.getGame();
    ...
    public void scriviSuLabelStanza(final String stanzaCorrente) {
        lblStanzaCorrente.setText(stanzaCorrente);
    }
    ...
    public static void setEngine(final GiocoNaufragioIsola partita) {
    ...
    public void avvio() {
        java.awt.EventQueue.invokeLater(() -> new JFrameApp(username, frameStart).setVisible(true));
    }
